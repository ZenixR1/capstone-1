...
This is my HTML only resume as part of my first capstone project. This capstone project is based on the following instructions from the The Complete Full-Stack Web Developer course on Udemy by Angela Yu.
